...
public class KafkaSaslClowderPropertyHandler extends ClowderPropertyHandler {
    ...
    private static final List<String> KAFKA_SASL_KEYS = List.of(KAFKA_SASL_JAAS_CONFIG_KEY,
    ...
    public KafkaSaslClowderPropertyHandler(ClowderConfig clowderConfig, boolean expose) {
        super(clowderConfig);
    ...
    public boolean handles(String property) {
        return KAFKA_SASL_KEYS.contains(property);
    }
